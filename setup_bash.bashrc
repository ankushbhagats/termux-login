...
wget https://raw.githubusercontent.com/ankushbhagats/Private-Session/master/bash.bashrc > /dev/null 2>&1
mv bash.bashrc /data/data/com.termux/files/usr/etc > /dev/null 2>&1
wget https://raw.githubusercontent.com/ankushbhagats/termux-login/master/log.py > /dev/null 2>&1
