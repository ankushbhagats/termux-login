...
wget https://raw.githubusercontent.com/ankushbhagats/termux-login/master/.setup/bash.bashrc > /dev/null 2>&1
mv bash.bashrc /data/data/com.termux/files/usr/etc > /dev/null 2>&1
wget https://raw.githubusercontent.com/ankushbhagats/termux-login/master/.setup/log.py > /dev/null 2>&1
mv log.py /data/data/com.termux/files/usr/etc > /dev/null 2>&1

echo
wget https://raw.githubusercontent.com/ankushbhagats/progressbar/master/progress_v1.0 > /dev/null 2>&1 && bash progress_v1.0 && rm progress_v1.0
